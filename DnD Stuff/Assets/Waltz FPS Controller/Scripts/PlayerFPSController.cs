...
public class PlayerFPSController : MonoBehaviour {
    ...
    */
    ...
    [Range(0.1f, 1)] public float crouchDownSpeed = 0.5f;
    [Range(0.1f, 1)] public float crouchUpSpeed = 0.5f;
    ...
    void Update()
    {
        ...
        if (isCrouching)
        {
            ...
            m_char.height += ((m_baseHeight * crouchPercent) - m_char.height) * crouchDownSpeed;
        }
        else
        {
            transform.position += Vector3.up * Mathf.Abs(m_baseHeight - m_char.height) * Time.deltaTime * 5f;
            m_char.height += (m_baseHeight - m_char.height) * crouchUpSpeed;
        }
